      ...
      <div className="flex-1 pb-20 p-10 w-sm">
        ...
        <ul className="flex flex-col space-y-5">
          {sortedChatbotsByUser.map((chatbot) => {
            return (
              <li key={chatbot.id} className="relative border rounded-md m-3">
                <div className="flex justify-between items-center">
                  <div className="flex items-center m-8">
                    <div className="flex items-center pb-1 flex-col">
                      {/* Only the Avatar is clickable */}
                ...
                <div className=" gap-10 md:gap-5 p-5 flex flex-col bg-gray-100">
                  ...
                  <div className="bg-blue-200 mt-4 text-center border border-blue-500 rounded-md max-w-2xl mx-auto">
                    <h3 className="italic pt-2 pl-4 pr-4">No of Sessions:</h3>
...
//xl:bg-pink-400 lg:bg-blue-500 md:bg-green-500 sm:bg-red-700
